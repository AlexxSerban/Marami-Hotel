...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen md:min-h-screen flex items-center justify-center overflow-hidden py-20 md:py-0">
      {/* Background Image */}
      ...
      <div className="relative z-10 container-custom text-center text-white px-4">
        ...
        >
          ...
          <motion.div
            ...
            className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 md:mb-8 text-gray-200 text-shadow max-w-4xl mx-auto leading-relaxed space-y-3 md:space-y-4"
          >
            <p>
