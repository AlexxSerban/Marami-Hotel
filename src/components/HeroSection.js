...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container-custom text-center text-white w-full px-4 py-16 md:py-20 lg:py-24">
        <motion.div
        ...
        >
          ...
          <div className="mb-6 md:mb-8 lg:mb-12">
            <SplitText
              text="Hotel Marami"
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-display font-bold text-shadow-lg leading-tight block"
              delay={100}
              duration={0.6}
              ease="power3.out"
              splitType="chars"
            ...
            <SplitText
              ...
              className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-display font-semibold text-primary-300 text-shadow-lg leading-tight block mt-2"
              delay={100}
              duration={0.6}
              ease="power3.out"
              splitType="chars"
