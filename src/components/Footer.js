        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-center md:text-left">
            ...
            <div className="flex space-x-6 text-sm">
              <Link to="/politica-confidentialitate" className="text-gray-400 hover:text-primary-400 transition-colors">
                Politica de Confidențialitate
              </Link>
              <Link to="/termeni-conditii" className="text-gray-400 hover:text-primary-400 transition-colors">
                Termeni și Condiții
              </Link>
